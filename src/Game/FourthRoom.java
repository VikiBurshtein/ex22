...
public class FourthRoom extends KeyAdapter implements GLEventListener {
    ...
    private Texture wallsTexture,ceilingTexture,floorTexture, startTexture, endTexture, tableTexture, gobletTexture;
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        tableModel = new WavefrontObjectLoader_DisplayList("fourthRoom/table.obj");
        gobletModel = new WavefrontObjectLoader_DisplayList("fourthRoom/goblet.obj");
